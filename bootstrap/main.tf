...
data "template_file" "bootstrap_script" {
  ...
  vars     = {
    ...
    consul_server_charge_type       = var.consul_server_charge_type
    consul_server_charge_duration   = var.consul_server_charge_duration
    nomad_server_charge_type        = var.nomad_server_charge_type
    nomad_server_charge_duration    = var.nomad_server_charge_duration
