...
locals {
  ...
  nomad_client_broker_image_id       = format("[%s]", join(", ", [for id in var.nomad_client_broker_image_id: format("\"%s\"", id)]))
  nomad_client_namesvr_image_id      = format("[%s]", join(", ", [for id in var.nomad_client_namesvr_image_id: format("\"%s\"", id)]))
  ...
  nomad_client_broker_root_password  = format("[%s]", join(", ", [for pass in var.nomad_client_broker_root_password: format("\"%s\"", pass)]))
  nomad_client_namesvr_root_password = format("[%s]", join(", ", [for pass in var.nomad_client_namesvr_root_password: format("\"%s\"", pass)]))
